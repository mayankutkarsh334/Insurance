...
```mermaid
graph TD
    A["You: 26, healthy, BANGALORE<br/>Premium is NOT a constraint<br/>Priority: Claims first"] --> B{"Do you have — or a family<br/>history of — diabetes, hypertension,<br/>asthma or high cholesterol?"}
    B -->|YES| C["ABHI Activ One MAX<br/>day-1 chronic cover is<br/>unique and decisive"]
    B -->|NO| D{"Does mental-health cover<br/>matter to you?"}
    D -->|YES| C2["ABHI — names Mental Illness<br/>Hospitalization as a covered<br/>benefit; HDFC never mentions it"]
    D -->|NO| E{"Do you want SI above<br/>Rs 2 Crore?"}
    E -->|YES| C3["ABHI — goes to Rs 6 Cr<br/>HDFC caps at Rs 2 Cr"]
    E -->|NO| F["HDFC OPTIMA SECURE+<br/><br/>Best claims record + best<br/>Bangalore network (620)<br/>Uncapped Infinite bonus<br/>No arbitration, no wallet lock-in<br/><br/>Cost advantage of ABHI is<br/>irrelevant to you"]
    style C fill:#f96,color:#000
    style C2 fill:#f96,color:#000
    style C3 fill:#f96,color:#000
