...
```mermaid
gantt
    title What is covered, and when — Optima Secure+ at age 26 (healthy, no PED)
    dateFormat YYYY-MM-DD
    axisFormat %b '%y
    section Day 1
    Accidents (always covered)          :done, a1, 2026-08-01, 1200d
    section 30-day timer
    Initial waiting - all illness       :crit, b1, 2026-08-01, 30d
    section 24-month timer
    Specific list - cataract, hernia, joint replacement, stones, GERD :active, c1, 2026-08-01, 730d
    section 36-month timer
    Pre-existing disease (if declared)  :active, d1, 2026-08-01, 1095d
```
